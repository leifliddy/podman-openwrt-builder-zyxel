...
RUN dnf upgrade -y &&\
    dnf install -y bzip2 ccache diffutils file findutils gcc git patch perl-File-Compare perl-File-Copy perl-FindBin perl-Thread-Queue rsync unzip vim-enhanced wget which xz &&\
    mkdir /root/.bashrc.d &&\
